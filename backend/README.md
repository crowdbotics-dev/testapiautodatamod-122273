...
## Project Structure
    ...
    ├── testapiautodatamod_122273  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_122273`
...
2. Clone this repo and `cd testapiautodatamod_122273`
